...
\begin{abstract}
Network traffic anomaly detection has become a necessity due to proliferation of information technologies across safety critical applications. However, conventional traffic anomaly detection mechanisms primarily rely on data with very high dimension. In this paper, we propose an efficient network anomaly detection mechanism by selecting essential features that can quickly detect multiple types of anomalies without compromising the detection accuracy.
...
Experimental results show that 
 ...
 we propose a hierarchical feature selection scheme to reduce the dimension of data and select essential features of network traffic.
\end{abstract}
