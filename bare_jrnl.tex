...
\begin{figure}
    \centering
    \includegraphics[scale=0.32]{fig/Cluster_Number_in_diff_delta.pdf}
    \caption{Number of clusters in 10 splitted data set under the effect of different distance threshould $\delta$. }
