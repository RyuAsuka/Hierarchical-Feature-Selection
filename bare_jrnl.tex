...
\thanks{Tongquan Wei is the corresponding author. e-mail: tqwei@cs.ecnu.edu.cn.}
\thanks{J. Mao, D. Jiang, Y. Hu, T. Wei and F. Shen are with the School of Computer Science and Technology, East China Normal University, Shanghai, 200062 China.}% 
}% <-this % stops a space
...
\begin{figure*}
    \centering
    \includegraphics[scale=0.45]{fig/confusion-matrix.pdf}
